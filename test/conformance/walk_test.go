...
})`, []conformanceData{{URL: "https://github.com/aledbf/ingress-conformance/tree/master/test/list/main_test.go#L11", TestName: "Kubelet-OutputToLogs",
		Description: `By default the stdout and stderr from the process
being executed in a pod MUST be sent to the pod's logs.` + "\n\n"}},
	},
	// Describe + It
...
})`, []conformanceData{{URL: "https://github.com/aledbf/ingress-conformance/tree/master/e2e/foo.go#L5", TestName: "Feature should work properly", Description: "It should have comment\n\n"}},
	},
	// KubeDescribe + It
	{"e2e/foo.go", `
...
})`, []conformanceData{{URL: "https://github.com/aledbf/ingress-conformance/tree/master/e2e/foo.go#L8", TestName: "Kubelet-OutputToLogs",
		Description: `By default the stdout and stderr from the process
being executed in a pod MUST be sent to the pod's logs.` + "\n\n"}},
	},
...
var _ = framework.SIGDescribe("Feature", func() {
	...
	Describe("Also described via", func() {
		...
		{URL: "https://github.com/aledbf/ingress-conformance/tree/master/e2e/foo.go#L6", TestName: "Feature Described by A ConformanceIt", Description: "description1\n\n"},
		{URL: "https://github.com/aledbf/ingress-conformance/tree/master/e2e/foo.go#L11", TestName: "Feature Also described via A nested ConformanceIt", Description: "description2\n\n"},
	}},
	// KubeDescribe + Context + It
	{"e2e/foo.go", `
var _ = framework.KubeDescribe("Feature", func() {
...
})`, []conformanceData{{URL: "https://github.com/aledbf/ingress-conformance/tree/master/e2e/foo.go#L7", TestName: "Feature with context should work",
		Description: `By default the stdout and stderr from the process
being executed in a pod MUST be sent to the pod's logs.` + "\n\n"}},
	},
	{"e2e/foo.go", `
...
})`, []conformanceData{{URL: "https://github.com/aledbf/ingress-conformance/tree/master/e2e/foo.go#L8", TestName: "Test with spaces",
		Description: `Should pick up testname even if it is not within 3 spaces
even when executed from memory.` + "\n\n"}},
	},
}
