...
## **List of Tests**
## [Ingress ...](https://github.com/aledbf/ingress-conformance/tree/master/test/e2e/common/basic.go#L33)
...
Total Conformance Tests: 1, total legacy tests that need conversion: 0, while total tests that need comment sections: 1
